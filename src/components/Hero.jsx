export default function Hero() {
  return (
    <section
      ...
      style={{ paddingTop: 'calc(var(--header-height) * 0.1)' }}
    >
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="#services" className="inline-flex items-center rounded-2xl bg-stone-900 px-5 py-3 text-white shadow hover:bg-stone-800">See services</a>
              <a href="#contact" className="inline-flex items-center rounded-2xl border border-stone-300 bg-white px-5 py-3 shadow-sm hover:shadow">Get a quote</a>
            </div>
